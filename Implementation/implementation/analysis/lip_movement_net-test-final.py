...
def capture_frames(cap, model):
    ...
    return test_speaking(cap, frames, model)


def test_speaking(cap, frames, model):
    state = 'Processing'
...
if __name__ == '__main__':
    test_video("E:\SEM 05 CSE19\The Deciding Project\Suspicious-Face-Detection\Implementation\implementation\models\model.h5")
    print("End Detection")
